...
\nn{trace preserving does not imply pivotal functor. 
See my unitary dual paper. 
Must show compatibility condtion.}
...
\nn{Insert the theorem which says it exists and says it is uniquely characterized by certain tangles.}
