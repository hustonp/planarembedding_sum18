...
$$ and $x^? = \overline x$ if $n$ is even and $x$ if $n$ is odd.
...
where the red strand represents $m$. We have a faithful tracial state given by: \textcolor{red}{insert picture here}

this makes $A_n$ a finite dimensional von Neumann algebra.
