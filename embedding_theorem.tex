...
For a general subfactor planar algebra $Q_{\bullet}$, the $2$-category $\cG$ can be interpreted as a semisimple multitensor category in the sense of \cite{egno}. When $Q_{\bullet}$ is of finite depth, $\cG$ is in fact a $2\times 2$ multifusion category.
