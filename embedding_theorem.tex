...
\item Similarly to \ref{condex} it's clear that $\Phi(\beta_n(x)) = \beta_{2r+n}(\Phi(x))$ in fact the inclusion from $P_{n,+} \to P_{n+1,+}$ is just the restriction of the inclusion from $Q_{2r+n,+} \to Q_{2r+n+1,+}$. 
