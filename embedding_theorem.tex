...
\end{thm} 
\begin{proof}
 For clarity, let us denote the conditional expectations and inclusions in $\cP_\bullet$ by $\overline{E}$ and $\overline{i}$, reserving the plain symbols for their counterparts in $\cQ_\bullet$. Similarly, let us denote the $n$-th Jones projection in $\cP_\bullet$ by $f_n$, reserving $e_n$ for the Jones projection in $\cQ_\bullet$.
