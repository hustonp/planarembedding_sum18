...
We refer the reader to \S\ref{ssec:moduledefs} for the definition, but we include a representative tangle below which acts amongst the algebras $\cM_k$ and the box spaces $\cP_{n,\pm}$:
