...
Furthermore we can retrieve the main result of \cite{penneys} as a corollary of this by letting $\cM$ be $\cC_{00}\oplus\cC_{11}$ and our simple object be $1_{0}$. Furthermore if we take $\cM$ to be $\cC_{10}\oplus\cC_{01}$ we obtain an embedding into the graph planar algebra of the dual principle graph.
