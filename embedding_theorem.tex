...
We refer the reader to \S\nn{} for the precise definition, but we include a representative tangle below which acts amongst the algebras $\cM_k$ and the box spaces $\cP_{n,\pm}$:
\dave{convention we always read inputs bottom to top for $\cM_\bullet$?}
$$
...
%
	\halfcircle{}{(0,0)}{2}{2}{}
%
	\openhalfcircle{}{(0,1)}{.3}{.4}{\scriptsize{$2^{\cM_\bullet}$}}
	\openhalfcircle{}{(0,-1)}{.3}{.4}{\scriptsize{$1^{\cM_\bullet}$}}
	\ncircle{unshaded}{(2.5,1)}{.4}{180}{\scriptsize{$3^{\cP_\bullet}$}}
	\ncircle{unshaded}{(1.5,0)}{.4}{0}{\scriptsize{$2^{\cP_\bullet}$}}
	\ncircle{unshaded}{(2.5,-1)}{.4}{90}{\scriptsize{$1^{\cP_\bullet}$}}
\end{tikzpicture}
\,:
...
%
	\halfcircle{}{(0,0)}{1}{.3}{}
%
	\openhalfcircle{}{(0,.4)}{.25}{.25}{\scriptsize{$2^{\cM_\bullet}$}}
	\openhalfcircle{}{(0,-.4)}{.25}{.25}{\scriptsize{$1^{\cM_\bullet}$}}
...
d^{-k}\cdot\,
\begin{tikzpicture}[baseline = -.1cm]
	\draw (.25,.25) arc (180:0:.25cm) -- (.75,-.25) arc (0:-180:.25cm);
%
	\halfcircle{}{(0,0)}{.8}{.3}{}
%
...
In order to define a module for a $\lambda$-lattice, in \S\ref{sec:MarkovTowers} we define the notion of a \emph{Markov tower}, which is a sequence of finite dimensional von Neumann algebras with faithful tracial states $(M_n, \tr_n)_{n\geq 0}$ together with a representation of Jones projections $e_n \in M_{n+1}$ for $n\geq 1$ satisfying the following properties:
\begin{enumerate}[label={\rm(\arabic*)}]
\item
