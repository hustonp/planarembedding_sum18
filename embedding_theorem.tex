...
\end{thm} 
\begin{proof}
 For clarity, let us denote the conditional expectation and inclusions in $\cP_\bullet$ by $\overline{E}$ and $\overline{i}$, reserving the plain symbols for their counterparts in $\cQ_\bullet$. Similarly, let us denote the $n$-th Jones projection in $\cP_\bullet$ by $f_n$, reserving $e_n$ for the Jones projection in $\cQ_\bullet$. 
...
\item (Conditional Expectation) \label{condex} 
 $\displaystyle\Phi(\overline{E_n}(x))=\Phi\left(
\begin{tikzpicture}[baseline]
 \draw (0,-.7) -- (0,.7);
 \draw (.15,.3) arc (180:0:.15cm) -- (.45,-.3) arc (0:-180:.15cm);
 \roundNbox{unshaded}{(0,0)}{.3}{0}{0}{}
...
$
\item (Right Inclusion)
 $\displaystyle \overline{i_n}(x)=i_n\left(
\begin{tikzpicture}[baseline]
 \draw (0,-.7) -- (0,0.7);
 \draw (0.45,-.7) -- (0.45,.7);
 \roundNbox{unshaded}{(0,0)}{.3}{0}{0}{}
...
\end{tikzpicture}
\,.
=d^2\Phi\left(E^{\c\cQ_{n,+}}_{\cQ_{n-1,-}}(x)
 \]
  \end{minipage}
}

\item (Left Inclusion) The left inclusion $i^{-}_{n} : \cP_{n,-} \to\cP_{n+1,+}$ is just the inclusion $A_1'\bigcap A_{n+1}\to A_0'\bigcap A_{n+1}$.
