...
\end{enumerate}
Here, we use the definition of $\tr^p_n$ from \eqref{eq:CompressedTrace}
...
To see condition (2) from the lemma holds, note that $E^p_2(pxp) = pE_2(x)p$ for all $x\in A_2$ as in  \eqref{eq:CompressedConditionalExpectation}.
