...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Compressions of inclusions of von Neumann algebras} 
...
%%%%%%%%%%%%%Shifting%%%%%%%%%%%%%
Suppose that $(A_n,\tr_n)$ is a strongly Markov sequence of von Neumann algebras. 
We know from \cite{MR2812459} that the inclusion $A_0 \subseteq A_2 \subseteq \left(A_4, \tr_4,d^{-2}(e_1e_2)(e_3e_2)\right)$ is standard. 
\nn{false; only true if $(A_n)$ is the Jones tower of a strongly markov inclusion.}
Thus we can find a Pimsner-Popa basis $B$ for $A_2$ over $A_0$.
\begin{remark}
