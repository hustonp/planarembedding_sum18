...
Let $M_0\subseteq (M_1,\tr_1)$ be a strongly Markov inclusion of finite von Neumann algebras with faithful, normal, tracial states, with $[M_1:M_0]=d^2$, and with Jones projections $e_n\in M_{n+1}$. Let the finite von Neumann Algebra $(M_n,\tr_n)$ be obtained by iterating the basic construction on $M_0\subseteq (M_1,\tr_1)$. We will construct a planar algebra called the \textit{canonical *-planar algebra of a strongly Markov inclusion} corresponding to $M_0\subseteq (M_1,\tr_1)$. We refer the reader to \cite{MR2812459} for more details on this construction. We will need the following proposition:
