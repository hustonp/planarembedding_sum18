...
Now since $\cM$ is finitely semisimple, the Markov tower $(M_n, \tr_n, e_n)$ has \emph{finite depth}, meaning the principal graph is finite.
...
The inclusion is said to be \textit{strongly Markov} if:
\begin{itemize}
