...
For a general subfactor planar algebra $Q_{\bullet}$, the $2$-category $\cG$ can be interpreted as a semisimple multitensor category $\cC$ in the sense of \cite{egno}. When $Q_{\bullet}$ is of finite depth, $\cC$ is in fact a $2\times 2$ multifusion category. 
...
\quad
\begin{tikzpicture}[baseline]
	\fill[shadedpink] (-.3,-.7) -- (-0.3,.7) -- (-.7,0.7) -- (-.7,-0.7) -- (-.3,-0.7);
...
\begin{tikzpicture}[baseline]
	\fill[left color=white, right color= shaded-blue] (0,-.7) -- (-.8,-.7) -- (-.8,.7) -- (0,.7) -- (0,-.7);
...
\begin{tikzpicture}[baseline]
	\fill[shaded-blue] (-0.45,.7) -- (0,.7) -- (0,-.7) -- (-0.45,-.7) -- (-0.45,.7);
	\draw (0,-.7) -- (0,0.7);
	\draw (-0.45,-.7) -- (-0.45,.7);
	\roundNbox{unshaded}{(0,0)}{.3}{0}{0}{}
	\node at (0,-.9) {\tiny{$n$}};
...
\sum_{b\in B}
\begin{tikzpicture}[baseline]
	\fill[shadedpink] (-1,-2.1) -- (-1,2.1) -- (-.6,2.1) -- (-.6,-2.1) -- (-1,-2.1);
...
\[
\begin{tikzpicture}[baseline]
	\fill[shadedpink] (-.9,-.7) -- (-0.9,.7) -- (-1.3,0.7) -- (-1.3,-0.7) -- (-0.9,-0.7);
