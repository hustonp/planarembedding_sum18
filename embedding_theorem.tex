...
\right).
$$
Using Lemma \ref{lem:MultistepJonesProjections}, one checks the map $\pi$ is an injective algebra map satisfying $\pi(x^\dag) = \pi(x)^*$, and is thus an isomorphism onto its image.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Planar modules and pivotal module categories} 

\nn{this section does the previous section for modules.}
