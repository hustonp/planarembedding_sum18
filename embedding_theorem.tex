...
\end{tikzpicture} \]
This map sends $Q_{n , +}$ to $P_{n,+}$ and $Q_{n , -}$ to $P_{n,-}$. In order to check that $\Phi(Q_{\bullet})$ is a sub $\dagger$-planar algebra, we use Lemma 2.48 in the paper of Penneys and Jones. % cite
