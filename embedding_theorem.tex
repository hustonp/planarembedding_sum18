...
\begin{remark}
Notice that shifting a Markov tower simply truncates the Bratteli diagram (as defined in \ref{Rem:BratteliDiagram}), and by a similar argument to the one used to show fact \ref{Fact:BratteliPrincipal}, the principal graph is unchanged.
\end{remark}
